...
import { Lock, ArrowRight, Loader2, Calendar, CheckCircle } from 'lucide-react';
          ...
          <div className="relative w-full max-w-md space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-blue-100/60 border border-blue-100 p-8 space-y-6 slide-up stagger-2">
              <div className="space-y-1">
                <h2 className="text-2xl font-extrabold text-slate-800">Set new password</h2>
                <p className="text-sm text-slate-500">Please choose a secure password for your account</p>
              </div>
              ...
              {success ? (
                <div className="space-y-6 fade-in text-center py-4">
                  ...
                  <p className="text-sm text-slate-600 px-2 leading-relaxed font-semibold text-green-700">
                    {success}
                  </p>
                  <div className="pt-2">
                    <Link
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <div className="slide-up stagger-4 space-y-1.5">
                    <label htmlFor="confirmPassword" className="block text-xs font-semibold text-slate-500 uppercase tracking-wide">
                    ...
                    <div className={`relative flex items-center rounded-xl border-2 transition-all duration-200 ${
                      ...
                      <Lock className={`absolute left-3.5 w-4 h-4 transition-colors ${focusedField === 'confirmPassword' ? 'text-blue-500' : 'text-slate-300'}`} />
                      <input
                        id="confirmPassword"
                        type={showPassword ? 'text' : 'password'}
                        placeholder="••••••••"
                    ...
                    {errors.confirmPassword && (
                      <p className="text-xs text-red-500 font-medium pl-1">{errors.confirmPassword.message}</p>
                    )}
                  </div>
